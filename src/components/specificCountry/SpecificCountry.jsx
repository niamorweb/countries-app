  ...
  return (
    <>
      ...
      <div className="container-specific-country">
        <Link className="links" to={"/countries-app/"}>
          <button className="btn-back-page">
            <img
              className="dark-mode-element"
              src="../assets/img/arrow-right-white.svg"
              alt=""
            />
            <img
              className="light-mode-element"
              ...
              <div className="presentation-country">
                ...
                <div className="list-details">
                  <ul className="list-infos list1">
                    ...
                    {country.subregion ? (
                      ...
                      <li>
                        <strong>Subregion: </strong>Undefined{" "}
                      </li>
                    )}
                    {country.capital ? (
                      <li>
                      ...
                      <li>
                        <strong>Capital: </strong>Undefined{" "}
                      </li>
                    )}
                  </ul>
                  ...
                  <ul className="list-infos list2">
                    ...
                    {country.currencies ? (
                      ...
                      <li>
                        {" "}
                        <strong>Currencies:</strong> undefined
                      </li>
                    )}
                ...
                <div className="border-country-div">
                  ...
                  <ul className="list-borders">
                    {country.borders ? (
                      country.borders.map((bordersCountry) => (
                        <span className="border">{bordersCountry}</span>
                      ))
                    ) : (
                      <span className="border">No bordering countries</span>
                    )}
                  </ul>
                </div>
              </div>
